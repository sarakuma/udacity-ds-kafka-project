...
# Define a Faust Stream that ingests data from the Kafka Connect stations topic and places it into a new topic with only the necessary information.

app = faust.App("stations-stream", broker="kafka://localhost:9092", store="memory://")
topic = app.topic("cta.stations", value_type=Station)
out_topic = app.topic("cta.stations.table.trends", partitions=1)
table = app.Table(
  'cta_stations_trends',
